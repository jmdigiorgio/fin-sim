 ...
 * MoneyInput Styles
 * 
 * Defines the custom styling for the MoneyInput component using Material-UI's
...
// Creates a styled version of Material-UI's TextField
export const StyledTextField = styled(TextField)(({ theme }) => ({
  ...
  '& .MuiOutlinedInput-root': {
    '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
      // Changes border color based on dark/light theme
